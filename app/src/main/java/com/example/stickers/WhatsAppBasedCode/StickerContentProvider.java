...
import static com.example.stickers.app.Constants.providerWhatsApp;
...
public class StickerContentProvider extends ContentProvider {
    ...
    public static Uri AUTHORITY_URI = new Uri.Builder().scheme(StickerContentProvider.CONTENT_SCHEME).authority(providerWhatsApp + ".WhatsAppLicensedCode.StickerContentProvider").appendPath(StickerContentProvider.METADATA).build();
    /**
    ...
    public boolean onCreate() {
        ...
        final String authority = providerWhatsApp + ".WhatsAppLicensedCode.StickerContentProvider";
        ...
        if (csp != null) {
            ...
            try {
                if (filename.equals("trayimage") && csp.getTrayImageUri() != null) {
                    ...
                    Log.e("tag***", "1-" + csp.getTrayImageUri());
                    ...
                    Log.e("tag***", "2-" + csp.getTrayImageUri());
                    try {
                        pfd = Objects.requireNonNull(getContext()).getContentResolver().openFileDescriptor(
    ...
    public String getType(@NonNull Uri uri) {
        ...
        switch (matchCode) {
            case METADATA_CODE:
                return "vnd.android.cursor.dir/vnd." + providerWhatsApp + ".WhatsAppLicensedCode.StickerContentProvider" + "." + METADATA;
            case METADATA_CODE_FOR_SINGLE_PACK:
                return "vnd.android.cursor.item/vnd." + providerWhatsApp + ".WhatsAppLicensedCode.StickerContentProvider" + "." + METADATA;
            case STICKERS_CODE:
                return "vnd.android.cursor.dir/vnd." + providerWhatsApp + ".WhatsAppLicensedCode.StickerContentProvider" + "." + STICKERS;
