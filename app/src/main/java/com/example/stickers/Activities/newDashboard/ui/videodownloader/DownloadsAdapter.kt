...
import com.example.stickers.Activities.newDashboard.ui.videodownloader.FileUtility.Companion.getDurationString
import com.example.stickers.R
import com.example.stickers.databinding.ItemDownloadBinding
import com.example.stickers.databinding.ItemDownloadedBinding
        ...
        override fun bind(model: Download) {
            ...
            if (model.path != null) {
                ...
                val pb = powerMenu.addItem(PowerMenuItem("Copy Link", R.drawable.copy_link, false))
                    ...
                    .setPadding(10)
                    .setIconSize(16)
                    .setTextColor(context!!.resources.getColor(R.color.grey))
