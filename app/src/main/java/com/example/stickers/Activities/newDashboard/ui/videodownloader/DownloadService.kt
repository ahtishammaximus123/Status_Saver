...
class DownloadService : Service() {
    ...
    companion object {
        ...
        var downloadsList : ArrayList<com.tonyodev.fetch2.Download>? = ArrayList()
        var downloads : MutableLiveData<List<com.tonyodev.fetch2.Download>?> = MutableLiveData()
        var updated : MutableLiveData<com.tonyodev.fetch2.Download?> = MutableLiveData()
        var canceled : MutableLiveData<com.tonyodev.fetch2.Download?> = MutableLiveData()
        var completed : MutableLiveData<com.tonyodev.fetch2.Download?> = MutableLiveData()
    }
    ...
    private fun initDownloader(){
        if(rxFetch == null || rxFetch?.isClosed == true) {
            val fetchConfiguration: FetchConfiguration = FetchConfiguration.Builder(applicationContext)
                ...
                .setNamespace("videoDownloaderModule")
        ...
        override fun onCompleted(download: com.tonyodev.fetch2.Download) {
            try {
                ...
                if (download.status == Status.COMPLETED
                    ...
                    val notifyIntent = Intent(this@DownloadService, FullScreenVideoActivity::class.java)
                    ...
                    val notification = NotificationCompat
                        ...
                        .setSmallIcon(R.drawable.whats_app_icon)
