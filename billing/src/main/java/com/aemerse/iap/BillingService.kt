...
class BillingService(
    ...
    override fun onBillingSetupFinished(billingResult: BillingResult) {
        log("onBillingSetupFinishedOkay: billingResult: ${billingResult.responseCode}")
    ...
    private suspend fun queryPurchases() {
        ...
        mBillingClient.queryPurchaseHistoryAsync(BillingClient.SkuType.INAPP
            ...
            if (list.isNullOrEmpty()) {
                ...
                Log.d(
                    "InApp",
                    "purchasesResult.getPurchasesList():" + subsResult.purchasesList
                )
            }
        }
    ...
    private fun processPurchases(purchasesList: List<Purchase>?, isRestore: Boolean = false) {
        ...
        log("processPurchases: Process Purchase is called...!!")
